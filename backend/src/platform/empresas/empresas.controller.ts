  ...
  try {
    ...
    const empresas = await query(
      `SELECT 
        ...
        e.gran_contribuyente,
        e.autoretenedor,
        e.agente_retenedor_iva,
        e.agente_retenedor_ica,
        e.resolucion_dian,
        e.fecha_resolucion,
        e.fecha_resolucion_desde,
        e.fecha_resolucion_hasta,
        e.prefijo_factura,
        e.rango_factura_desde,
        e.rango_factura_hasta,
        e.numeracion_actual,
        e.software_id,
        e.pin_software,
        e.ambiente,
        ...
        l.tipo_facturacion as licencia_tipo,
        l.fecha_inicio as licencia_inicio,
        DATE_FORMAT(l.fecha_fin, '%Y-%m-%d') as licencia_fin,
        DATEDIFF(l.fecha_fin, CURDATE()) as dias_restantes,
        p.nombre as plan_nombre,
        DATE_FORMAT(e.created_at, '%Y-%m-%d') as fecha_creacion
      FROM empresas e
