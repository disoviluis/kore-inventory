-- Actualizar empresa ID=6 con todos los datos de EVEREST SA (usando NIT diferente para evitar duplicado)
UPDATE empresas SET 
  nombre = 'EVEREST SA',
  razon_social = 'EVEREST SOCIEDAD ANÓNIMA',
  nit = '900456788',
  email = 'admin@everestsa.com.co',
...
SELECT id, nombre, nit, email, telefono, slogan, regimen_tributario, gran_contribuyente, resolucion_dian 
FROM empresas 
WHERE id = 6;
