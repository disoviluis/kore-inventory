-- ============================================================================
-- MIGRACIÓN SEGURA: FASE 4 - FACTURACIÓN ELECTRÓNICA
-- Compatible con campos existentes
-- ============================================================================

USE kore_inventory;

-- Habilitar continuación en caso de errores
...
-- Insertar retenciones (IGNORE para no duplicar)
...
SELECT 'Migración completada. Algunos campos pueden haber existido previamente.' AS mensaje;
